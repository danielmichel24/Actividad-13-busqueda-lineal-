...
public:
    ...
    T* buscar(const T& v);
    Arreglo<T*> buscar_todos(const T& dato);
    ...
    friend Arreglo<T>& operator<<(Arreglo<T> &a, const T& dato)
    {
...
template <class T>
T* Arreglo<T>::buscar(const T& dato)
{
...
template <class T>
Arreglo<T*> Arreglo<T>::buscar_todos(const T& dato)
{
    Arreglo<T*> ptrs;
